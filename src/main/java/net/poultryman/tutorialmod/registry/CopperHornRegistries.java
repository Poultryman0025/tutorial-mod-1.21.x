...
public class CopperHornRegistries {
    ...
    public static final DefaultedRegistry<CopperHornInstrument> INSTRUMENT;

    public CopperHornRegistries() {
    }

    static {
        INSTRUMENT = FabricRegistryBuilder.createDefaulted(INSTRUMENT_KEY, TutorialMod.id("great_copper_horn")).buildAndRegister();
    }
}