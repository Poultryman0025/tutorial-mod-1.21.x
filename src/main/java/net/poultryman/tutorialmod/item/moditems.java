...
public class moditems {
    ...
    public static final Item Wrench = registerItem("wrench", new WrenchItem(new Item.Settings().component(DataComponentTypes.DEBUG_STICK_STATE, DebugStickStateComponent.DEFAULT).rarity(Rarity.RARE).maxCount(1).maxDamage(128)));
    ...
    public static void onInitialize()
    {
        ...
        {
            entries.addAfter(Items.FISHING_ROD, Wrench);
        });
    }
}
